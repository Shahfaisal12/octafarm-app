...
const Hero = () => {
  return (
    <div className="hero-section py-3 py-md-5 my-0 my-md-5">
      <div className="hero-bg-image bg_img_index">
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6">
            <h1 className='fw-bold'>Maximize Staking Returns <br />with Auto-Compounding</h1>
          ...
          <div className="col-md-6">
            <div className="embed-video mt-3 mt-md-0">
