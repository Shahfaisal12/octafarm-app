...
const Faqs = () => {
  ...
  return (
    <div className='react-faqs-section py-5'>
      <div className="container">
        <h1><span className='fw-bold'>FAQs</span> <span className='fst-italic fs-6 color-6d8bb0'>- frequently asked questions</span></h1>
        <Faq
          data={data}
          styles={styles}
          config={config}
